...
public class Review extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 204)));
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "sdlkfj", null, "dsaljf", "dsaflj", "ldsfj", "adslfj"},
            ...
            new String [] {
                "Order ID", "Customer ID", "Business ID", "Product ID", "Rating", "Comment", "Date"
            }
        ) {
